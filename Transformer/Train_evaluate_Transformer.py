...
def train_model(model, train_loader, val_loader,device,optimizer,criterion,scheduler,early_stopping_patience = 30, epochs=100):
...
def evaluate_model_by_activity(model, test_df,device,criterion, scaler,sig= ["Interpolated Values_Waist Acceleration"], batch_size=4 , num_time_steps=10, activity_column='Activity Code',activity_rmse_across_folds = None):
            model.eval()
